                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('task.update', [$task]) }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="task_title" type="text" class="form-control @error('task_title') is-invalid @enderror" name="task_title" value="{{$task->title}}"
                                        autofocus>
                                        @error('task_title')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <img src="{{$task->logo}}" alt="{{$task->title}}" width="100" height="100">
                                    @error('task_logo')
                                    <span role="alert" class="invalid-feedback">
                                        <strong>*{{$message}}</strong>
                                    </span>
                                ...
                                <div class="col-md-6">
                                    <select class="form-control @error('owner_id') is-invalid @enderror" name="owner_id">
                                        @foreach ($owners as $owner)
                                            <option value="{{ $owner->id }}"@if($task->owner_id == $owner->id) selected @endif>{{ $owner->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('owner_id')
                                    <span role="alert" class="invalid-feedback">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="task_start_date" type="datetime-local" class="form-control @error('task_start_date') is-invalid @enderror"" name="task_start_date" value="{{$task->start_date}}"
                                        autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="task_end_date" type="datetime-local" class="form-control @error('task_end_date') is-invalid @enderror" name="task_end_date" value="{{$task->end_date}}"
                                        autofocus>
                                        @error('task_end_date')
                                        <span role="alert" class="invalid-feedback">
                                            <strong>*{{$message}}</strong>
